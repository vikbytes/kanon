...
class TerminalColorsTest {
    ...
    fun `test stripAnsiCodes removes all color codes`() {
        val coloredText =
            "This is ${TerminalColors.RED}red${TerminalColors.RESET} and ${TerminalColors.BLUE}blue${TerminalColors.RESET} text"
    ...
    fun `test stripAnsiCodes with multiple formatting`() {
        val complexText =
            "This is ${TerminalColors.BOLD}${TerminalColors.RED}bold red${TerminalColors.RESET} and " +
